...
#  @PickerCheckIn
  Scenario Outline: Check-In Picker with invalid siteId
    ...
    Examples:
      | attendeeId               | checkinTime      | deviceSerialNumber | siteId  |
      | 659fd2585c2fd619b4032812 | 09-01-2024 18:45 | 1234567890         |         |
      | 659fd2585c2fd619b4032812 | 09-01-2024 18:45 | 1234567890         | null    |
      | 659fd2585c2fd619b4032812 | 09-01-2024 18:45 | 1234567890         | 1014@#$ |
