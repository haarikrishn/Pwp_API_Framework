...
public class CommonUtilities implements ConStants {
    ...
    static ThreadLocal<ConfirmDeliveryPOJO> threadSafeConfirmDelivery = new ThreadLocal<>();
    ...
    public static void setConfirmDeliveryPOJO(ConfirmDeliveryPOJO confirmDelivery){
        CommonUtilities.threadSafeConfirmDelivery.set(confirmDelivery);
    }

    //getting the ThreadSafe ConfirmDeliveryPOJO class Object for parallel execution
    public static ConfirmDeliveryPOJO getConfirmDeliveryPOJO(){
        return threadSafeConfirmDelivery.get();
    }
