...
@CucumberOptions(features = "src/test/resources/features/SingleSuite/ConfirmDelivery.feature",
		 		 tags = "@CDDT or @SO or @Excel or @ExcelDDT",
		         dryRun = false,
...
public class ConfirmDeliveryTestRunner {
